 ...
 */
export enum ListDestinationsStatus {
    Success = "success",
}
 ...
 */
export class ListDestinationsResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata({ elemType: components.Destination })
    @Expose({ name: "data" })
...
export class ListDestinationsResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    object?: ListDestinationsResponseBody;
}
