 ...
 */
export enum FieldNormalization {
 ...
 */
export class HighWaterMarkAttributes extends SpeakeasyBase {
    /**
 ...
 */
export class DbtCloud extends SpeakeasyBase {
    /**
 ...
 */
export class Fivetran extends SpeakeasyBase {
    /**
     * The Fivetran job id.
     */
    @SpeakeasyMetadata()
 ...
 */
export class SyncSequence extends SpeakeasyBase {
    /**
...
export class Sync extends SpeakeasyBase {
    ...
    @Type(() => HighWaterMarkAttributes)
    highWaterMarkAttributes?: HighWaterMarkAttributes;
